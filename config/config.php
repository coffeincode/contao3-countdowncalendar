...
$GLOBALS['FE_MOD']['countdowncalendar']=array (
    'countdowncalendar'     => 'ModuleCountdownCalendar',
    'countdown_door_reader'   => 'ModuleCountdownDoorReader',
    
);

$GLOBALS['TL_MODELS'] = array
(
    'tl_countdowncalendar'       => 'CountdownCalendarModel',
    'tl_countdown_door' => 'CountdownDoorModel'
);
